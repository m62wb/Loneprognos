...
window.saveProfilePopup = function () {
  ...
  // 4. Sätt värdena i gränssnittet
  lagSelect.value = lag;
  salaryInput.value = cleanSalary;

  // 5. Spara profilen (nu med rätt lag & lön)
  ...
  // 6. Sätt dropdownen till den nyss sparade profilen
  document.getElementById('profileSelect').value = name.trim();

  // Uppdatera kalkylatorn så att allt räknas om
...
// Fyll dropdownen vid sidladdning
